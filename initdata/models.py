...
class ProjectBaseInfo(models.Model):
    pro_name = models.CharField('项目名称', max_length=50, db_index=True, unique=True) 
...
class ProjectItemValues(models.Model): 
    # project_id = models.ForeignKey(ProjectBaseInfo, related_name='pro_info', help_text='项目基础信息表外键')
